...
class Utility:
    ...
    def check_dependency(self, params, description, shell=False):
        try:
            ...
            self.output.error("{0} is required by the Azure IoT Edge Dev Tool. For installation instructions, see the README at https://github.com/Azure/iotedgedev/wiki/dev-machine-setup#local-dev-machine-setup.".format(description))
            sys.exit(-1)
